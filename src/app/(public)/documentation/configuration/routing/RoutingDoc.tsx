 ...
 *
 * This document provides detailed information on how to effectively use the routing system in aPilot React.
	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				aPilot React utilizes a custom routing system based on the popular{'  '}
				<a
