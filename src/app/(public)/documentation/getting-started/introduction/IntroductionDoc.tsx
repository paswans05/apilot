...
/**
 * Introduction Doc
 * This document provides information on how to use aPilot React.
 */
	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				This version of aPilot is <i>NOT</i> a traditional admin template, it's a React app written entirely with
			...
			<Typography
				...
				component="p"
			>
				While aPilot React is a great tool and source for learning React, it also requires at least an entry-level
			...
			>
				...
				recommend checking the React before start doing anything with aPilot.
			</Typography>
			<Typography
				className="text-2xl mt-5 mb-2.5 font-bold"
				variant="h5"
