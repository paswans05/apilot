...
/**
 * Installation Doc
 * This document provides information on how to install aPilot React.
 */
	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				To install and use aPilot React, you will need{' '}
				<a
			...
			<Typography
				...
				variant="h6"
			>
				B. Installing aPilot React
			</Typography>

			<Typography component="div">
				Before you begin installing aPilot, prepare a folder where you can unzip the downloaded .zip file.
			</Typography>
			...
			<div className="mx-4 my-8">
				...
				<ul className="list-disc mx-4">
					<li>
						...
						>
							<li>
								aPilot React ViteJs Demo Project <b>aPilot-React-vx.x.x-vitejs-demo.zip</b>
							</li>
							<li>
								aPilot React NextJs Demo Project <b>aPilot-React-vx.x.x-nextjs-demo.zip </b>
							</li>
						</Typography>
						<Typography
							className="mt-3"
					...
					<li>
						...
						>
							<li>
								aPilot React ViteJs Skeleton Project <b>aPilot-React-vx.x.x-vitejs-skeleton.zip</b>
							</li>
							<li>
								aPilot React NextJs Skeleton Project <b>aPilot-React-vx.x.x-nextjs-skeleton.zip</b>
							</li>
						</Typography>
						<Typography
							className="mt-3"
						...
						>
							...
							functionality of aPilot without the Demo applications, pages and UI sections. <b>DO</b> use
