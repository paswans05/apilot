	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				The aPilot React uses material-ui's theming by default. You can create theme color schemes with defining
			...
			>
				{`
				/**
				* The themesConfig object is a configuration object for the color themes of the aPilot application.
				*/
