	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				One of the strong sides of the aPilot React is its Page layout components.
			</Typography>
			<Typography
				className="mb-4"
				component="p"
			>
				Every single app, pre-built pages uses the aPilot React's page layout components.
			</Typography>
			<Typography
				className="mb-4"
				component="p"
			...
			<Typography
				...
				component="p"
			>
				Because page layout components, it's very easy to replicate any page style that you can find in aPilot
				React.
			</Typography>
