...
/**
 * The OverviewPageLayoutsUI component provides an overview of aPilot React's page layouts.
 */
		...
		<>
			...
			<section className="prose prose-sm dark:prose-invert">
				...
				<Typography paragraph>
					Page layouts in aPilot React are pre-designed, customizable templates that serve as the foundation for
				...
				<Typography paragraph>
					aPilot React's page layouts are designed to be intuitive and easy to implement. Simply copy the
