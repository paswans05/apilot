	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				aPilot comes with a variety of different Theme Layouts which you can see and try them from the
			...
			<Typography
				...
				component="p"
			>
				aPilot React has a powerful layout system which allows you to configure and use a different layout per
				route.
			</Typography>
			...
			>
				...
				page where there isn't any toolbar or navbar showing, without leaving the aPilot React.
			</Typography>
