		...
		<>
			...
			<div className="flex-auto">
				<div>
					...
					<Typography className="mb-4">
						To simply put, Tailwind provides helper classes for almost every CSS rule available. aPilot
					...
					<Typography
						...
						component="p"
					>
						aPilot React developed based on Material-UI as ui library.
						<a
							className="mx-1"
						...
						uses emotion at its core. Therefore the aPilot React supports
						<a
							className="mx-1"
				...
				<div>
					...
					>
						...
						find the config file of Tailwind with named "<b>tailwind.js</b>" under the root of aPilot React.
					</Typography>
				</div>
