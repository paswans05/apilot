...
/**
 * Updating aPilot React Doc
 * This document provides information on how to update aPilot React.
 */
	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				aPilot React isn’t an end product or an extension so there is no easy way to update the project. Due to
				the nature of apps, we cannot give any set instructions for updating aPilot React. It heavily depends on
				your project and it's up to you to update your code. However, there are a couple points that we want to
				put forward which might help you to keep aPilot React updated:
			</Typography>
			...
			>
				<ol>
					...
					<li className="mb-4">
						...
						changes manually, but it's the best way to keep the aPilot React updated.
					</li>
				</ol>
			</Typography>
		</>
