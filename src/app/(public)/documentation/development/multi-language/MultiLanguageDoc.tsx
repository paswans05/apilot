	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				To change the default language of the aPilot React, you need to change <code>lng</code> setting in the
...
const handleLanguageChange = async (newLanguageId) => {
  await changeLanguage(newLanguageId);
			...
			<Typography
				...
				component="p"
			>
				aPilot React uses a custom I18nProvider to manage language settings and provide language-related
			...
			<ul className="list-disc list-inside mb-4">
				...
				<li>Integrates with aPilot settings to update the layout direction</li>
			</ul>
