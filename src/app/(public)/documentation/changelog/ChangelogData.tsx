...
const changelogData: ChangelogItemType[] = [
	...
	},
	{
		...
		date: '2024-10-21',
		newChanges: [
			'🚀 aPilot React Nextjs version launched!',
			...
			<div className="text-base p-6 border-2 rounded-xl w-full max-w-2xl mt-10 mb-6">
				<ul className="list-disc">
					...
					<Typography
						...
						className="leading-[2]"
					>
						Starting with the latest skeleton version of aPilot React offers a pristine base, facilitating a
			...
			<div className="text-base p-6 border-2 rounded-xl w-full max-w-2xl mt-10 mb-6">
				<ul className="list-disc">
					...
					<Typography
						...
						className="leading-[2]"
					>
						You may also want to consider starting with the latest skeleton version of aPilot React, which is
			...
			<div className="text-base p-6 border-2 border-red-500 rounded-xl w-full max-w-2xl mt-10 mb-6">
				<ul className="list-disc">
					<Typography
						...
						className="leading-[2] mb-4"
					>
						This is the new major version of the aPilot React and it's completely different from previous
	...
	},
	{
		...
		fixedChanges: [
			'aPilot vertical navigation collapse items don’t have to be collapsed whenever navigation updated or location path changed.'
		],
		breakingChanges: [
