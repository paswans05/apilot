...
/**
 * The defaultSettings object defines the default settings for the aPilot application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the aPilot application.
