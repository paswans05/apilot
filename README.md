...
# aPilot React Versions
## Available Versions
- **aPilot React ViteJs** - Single Page Application (SPA)
...
- **aPilot React NextJs** - Server Side Rendering (SSR)
...
- [aPilot Theme Official Website](https://fusetheme.com/)
